...
\newcommand{\NameEmailPhoneSiteGithub}[6]{
  ...
  \textit{Technical Cloud Architect}\hfill \textit{website } #4 \hspace{25pt}\textit{linkedin } #5 \hspace{25pt}\textit{github } #6
  \par \normalsize \normalfont
}
...
%% you can upload a photo and include it here...
  \begin{wrapfigure}{l}{0.5\textwidth}
    \vspace*{-2em}
    \includegraphics[width=0.15\textwidth]{../assets/markus-schulte}
  \end{wrapfigure}
...
%\MySlogan{Curriculum Vitae}
  ...
  \NameEmailPhoneSiteGithub{Markus Schulte}{+49 (178) 721 7768}{mail@schulte-development.de}{\href{https://schulte-development.de}{schulte-development.de}}{\href{https://www.linkedin.com/in/markus-schulte/}{linkedin.com/in/markus-schulte/}}{\href{https://github.com/SchulteDev}{github.com/SchulteDev}}
